...
export const TERMINAL_THEMES = {
  ...
  "tokyo-night-storm": theme("Tokyo Night Storm", "Softer blue-black contrast",
    { background: "#1F2335", surface: "#292E42", text: "#C0CAF5", muted: "#737AA2", accent: "#7AA2F7", danger: "#F7768E" }, {
  ...
  "catppuccin-frappe": theme("Catppuccin Frappé", "Muted pastel dusk",
    { background: "#292C3C", surface: "#414559", text: "#C6D0F5", muted: "#949CBB", accent: "#CA9EE6", danger: "#E78284" }, {
  ...
  "rose-pine-moon": theme("Rosé Pine Moon", "Gentle lavender moonlight",
    { background: "#232136", surface: "#2A273F", text: "#E0DEF4", muted: "#908CAA", accent: "#C4A7E7", danger: "#EB6F92" }, {
    background: "#232136", foreground: "#E0DEF4", cursor: "#E0DEF4",
    selectionBackground: "#44415A",
    black: "#2A273F", red: "#EB6F92", green: "#3E8FB0", yellow: "#F6C177",
    blue: "#9CCFD8", magenta: "#C4A7E7", cyan: "#EA9A97", white: "#E0DEF4",
    brightBlack: "#6E6A86", brightRed: "#EB6F92", brightGreen: "#3E8FB0",
    brightYellow: "#F6C177", brightBlue: "#9CCFD8", brightMagenta: "#C4A7E7",
    brightCyan: "#EA9A97", brightWhite: "#FFFFFF",
  }, "#C4A7E7"),
  ...
  "github-dark-dimmed": theme("GitHub Dark Dimmed", "Comfortable low-glare contrast",
    { background: "#1C2128", surface: "#2D333B", text: "#ADBAC7", muted: "#768390", accent: "#539BF5", danger: "#F47067" }, {
  ...
  oxocarbon: theme("Oxocarbon", "Industrial black with luminous color",
    { background: "#161616", surface: "#262626", text: "#F2F4F8", muted: "#8D8D8D", accent: "#78A9FF", danger: "#FF7EB6" }, {
    background: "#161616", foreground: "#F2F4F8", cursor: "#FFFFFF",
    selectionBackground: "#393939",
    black: "#161616", red: "#EE5396", green: "#42BE65", yellow: "#FFE97B",
    blue: "#33B1FF", magenta: "#BE95FF", cyan: "#3DDBD9", white: "#DDE1E6",
    brightBlack: "#525252", brightRed: "#FF7EB6", brightGreen: "#42BE65",
    brightYellow: "#FFE97B", brightBlue: "#78A9FF", brightMagenta: "#D4BBFF",
    brightCyan: "#08BDBA", brightWhite: "#FFFFFF",
  }, "#78A9FF"),

...
export class Palette {
  ...
  _staticItems() {
    ...
    const items = [
      ...
      { kind: "view", label: "text size: smaller", hint: "Alt+Shift+−", run: () => a.fontSmaller() },
      { kind: "view", label: "text size: bigger", hint: "Alt+Shift++", run: () => a.fontBigger() },
      { kind: "view", label: "text size: reset", hint: "Alt+Shift+0", run: () => a.fontReset() },
